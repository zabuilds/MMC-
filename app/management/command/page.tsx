    ...
    <main style={{ minHeight: "100vh", padding: "32px 24px 64px" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto" }}>
        ...
        <section style={{ background: "var(--navy)", color: "white", borderRadius: 20, padding: 26, marginBottom: 18 }}>
          ...
          <div style={{ marginTop: 14, opacity: 0.82 }}>Capacity: {command.capacity.status} · QA: {command.qa.status} · Report: {command.report.status} · Open exceptions: {command.exceptions.length}</div>
        </section>
